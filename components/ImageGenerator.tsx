  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-white tracking-tight">AI Image Generator</h2>
        <p className="mt-2 text-lg text-slate-400">Create stunning visuals from simple text descriptions.</p>
      </div>
