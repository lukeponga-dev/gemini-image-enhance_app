...
const Gallery: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      {galleryItems.length === 0 ? (
        <div className="text-center py-16 px-4 bg-gray-800/30 rounded-2xl border border-gray-700/50">
          ...
          <p className="mt-2 text-base text-gray-400">Generate or edit an image and click the 'Save' button to see it here.</p>
        </div>
      ) : (
